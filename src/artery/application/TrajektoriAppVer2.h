#ifndef ARTERY_TRAJEKTORIAPPVER2_H_
#define ARTERY_TRAJEKTORIAPPVER2_H_

#include "artery/application/ItsG5BaseService.h"
#include "artery/application/VehicleDataProvider.h"
#include "KalmanFilter2D.h" // <- PENTING: Include file KF kita
...
struct AgentHistory {
    ...
    std::unique_ptr<KalmanFilter2D> kf_state;
    // ----------------------
};

// Ganti nama class
class TrajektoriAppVer2 : public ItsG5BaseService
{
    public:
...
#endif /* ARTERY_TRAJEKTORIAPPVER2_H_ */
