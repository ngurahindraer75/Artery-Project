#ifndef ARTERY_TRAJEKTORIAPPKFV5_H_
#define ARTERY_TRAJEKTORIAPPKFV5_H_
...
struct MovementData {
    ...
    double local_x;
    double local_y;
    // TAMBAHAN: Variabel untuk dekomposisi vektor kecepatan
    double vel_x; 
    double vel_y;
};
...
class TrajektoriAppKFv5 : public ItsG5BaseService {
public:
    virtual ~TrajektoriAppKFv5();
